(function () {
	...
	if (typeof MobileCRM === "undefined") {
		MobileCRM = {
			...
			UI: {
				...
				MessageBox: function (title, defaultText) {
					...
					/// <field name="multiLine" type="Boolean">Whether the message is multi line.</field>
		...
		MobileCRM.Bridge.prototype.exposeObjectAsync = function (method, paramsList) {
			...
			/// <param name="method" type="String">The name of the method implemented by object class.</param>
			/// <param name="paramsList" type="Array">An array with parameters that should be passed to a method.</param>
			/// <returns type="MobileCRM.ExposedObject">Yhe Javascript placeholder object for exposed managed object.</returns>
			var objId = ++_tmpObjId;
		...
		MobileCRM.Bridge.prototype.enableZoom = function (enable) {
			...
			/// <param name="enable" type="Boolean">Indicate whether to enable or disable zooming support.</param>
		...
		MobileCRM.Metadata.getActivities = function () {
			...
			for (var entity in obj) {
				var meta = obj[entity];
				if (meta && meta.isEnabled && meta.canRead() && (meta.attributes & 0x0010) != 0)
					arr.push(meta.name);
			}
		};
		...
		MobileCRM.UI.FormManager.showEditDialog = function (entityName, id, relationship) {
		...
		MobileCRM.UI.FormManager.showNewDialog = function (entityName, relationship) {
			/// <summary>Shows a new entity dialog.</summary>
			/// <param name="entityName" type="String">The entity name.</param>
			/// <param name="relationship" type="MobileCRM.RelationShip">The optional relationship with a parent entity.</param>
			MobileCRM.UI.FormManager.showEditDialog(entityName, null, relationship);
		}
		...
		MobileCRM.UI.LookupForm.prototype.show = function (success, failed, scope) {
			...
			/// <param name="failed" type="function(errorMsg)">The errorCallback which is called asynchronously in case of error.</param>
			/// <param name="scope" type="Object">The scope for callbacks.</param>
			MobileCRM.bridge.command("lookupForm", JSON.stringify(this), success, failed, scope);
		};
		...
		MobileCRM.UI.EntityForm.onCanExecuteCommand = function (command, handler, bind, scope) {
			...
			/// <param name="bind" type="Boolean">Determines whether to bind or unbind the handler.</param>
			/// <param name="scope" type="Object">The scope for handler calls.</param>
			/// <remarks>This function is obsolete. Please use <see cref="MobileCRM.UI.EntityForm.enableCommand">MobileCRM.UI.EntityForm.enableCommand</see> instead.<br/>Handlers used for this method cannot block the execution by UI tasks or call other bridge commands. Otherwise, the deadlock may occur on some platforms.</remarks>
		...
		MobileCRM.UI.EntityForm.enableCommand = function (command, enable) {
			...
			MobileCRM.bridge.invokeMethodAsync("EntityForm", "EnabledCommandByName", [command, enable]);
		}
		...
		if (typeof CrmBridge !== "undefined") {
			...
			if (typeof window.external !== "undefined" && window.external) {
				if (typeof window.external.notify !== "undefined") {
					...
					var platformName = navigator.userAgent.indexOf("Windows Phone") > 0 ? "WindowsPhone" : "WindowsRT";
